/datum/game_mode/traitor/double_agents
	...
	restricted_jobs = list("Cyborg", "AI", "Captain", "Head of Personnel", "Chief Medical Officer", "Research Director", "Chief Engineer", "Head of Security", "MoMMI", "Nanotrasen Representative") // Human / Minor roles only.
	required_players = 15
	required_enemies = 5
