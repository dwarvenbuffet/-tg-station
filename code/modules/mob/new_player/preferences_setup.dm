...
/datum/preferences/proc/update_preview_icon()		//seriously. This is horrendous.
	...
	if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
		...
		switch(job_civilian_high)
			...
			if(NTREP)
				clothes_s = new /icon('icons/mob/uniform.dmi', "centcom_officer")
				clothes_s.Blend(new /icon('icons/mob/feet.dmi', "combat"), ICON_OVERLAY)
				clothes_s.Blend(new /icon('icons/mob/hands.dmi', "combat"), ICON_UNDERLAY)
