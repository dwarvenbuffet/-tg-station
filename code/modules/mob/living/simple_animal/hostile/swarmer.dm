...
/mob/living/simple_animal/hostile/swarmer
	...
	loot = list(/obj/effect/decal/cleanable/robot_debris, /obj/item/bluespace_crystal/artificial)
	del_on_death = 1
...
/mob/living/simple_animal/hostile/swarmer/say(var/message)
	. = ..(message, "S")
...
/mob/living/simple_animal/hostile/swarmer/proc/DisperseTarget(var/mob/living/target)
	...
	var/turf/simulated/floor/F = find_safe_turf(zlevel=ZLEVEL_STATION)
	if(!F)
		return
...
/obj/effect/swarmer/destructible/New()
	..()
	set_light(light_strength, 2)
...
/obj/effect/swarmer/destructible/attackby(obj/item/I, mob/living/user)
	..()
	...
	if(message)
		for(var/mob/M in mob_list)
			if(isswarmer(M))
				M << rendered
			if(isobserver(M))
				var/link = "<a href='byond://?src=\ref[M];follow2=\ref[M];follow=\ref[src]'>Follow</a>"
				M << "[link] [rendered]"
